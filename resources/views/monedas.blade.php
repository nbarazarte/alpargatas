@extends('layouts.appCryptiaSmartyMonedas')
		...
		<ul>
			...
			<li data-index="rs-309" data-masterspeed="1000" data-transition="slideoverhorizontal" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="1000"  data-thumb=""  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Bitcoin" data-description="">
				...
				<div class="tp-caption BigBold-Title   tp-resizeme rs-parallaxlevel-0" 
					...
					style="z-index: 6; white-space: nowrap;">BITCOIN 
				</div>
				...
				<div class="tp-caption BigBold-SubTitle   rs-parallaxlevel-0" 
					...
					style="z-index: 6; min-width: 410px; max-width: 410px; max-width: 60px; max-width: 60px; white-space: normal;"><b>LA PRIMERA CRIPTOMONEDA</b>. 
				</div>
				...
				<div class="tp-caption BigBold-Button rev-btn  rs-parallaxlevel-0" 
					...
					style="z-index: 6; white-space: nowrap;border-color:rgba(255, 255, 255, 0.25);outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;">
					<a style="color: #FFFFFF" href="#bitcoin">
						<b>LEER MÁS</b>
					</a>
				</div>
			...
			<li data-index="rs-311" data-masterspeed="1000"  data-transition="slideoverhorizontal" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="1000"  data-thumb=""  data-rotate="0"  data-saveperformance="off"  data-title="Ripple" data-description="">
				...
				<div class="tp-caption BigBold-Title   tp-resizeme rs-parallaxlevel-0" 
					...
					style="z-index: 6; white-space: nowrap;">RIPPLE 
				</div>
				...
				<div class="tp-caption BigBold-SubTitle   rs-parallaxlevel-0" 
					...
					style="z-index: 6; min-width: 410px; max-width: 410px; max-width: 60px; max-width: 60px; white-space: normal;"><b>LA CRIPTOMONEDA DE LOS BANCOS</b>
				</div>
				...
				<!-- LAYER NR. 4 -->
					...
					style="z-index: 6; white-space: nowrap;border-color:rgba(255, 255, 255, 0.25);outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;">
					<a style="color: #FFFFFF" href="#ripple">
						<b>LEER MÁS</b>
					</a>
				</div>
			...
			<li data-index="rs-312" data-masterspeed="1000"  data-transition="slideoverhorizontal" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="1000"  data-thumb=""  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Ethereum" data-description="">
				...
				<div class="tp-caption BigBold-Title   tp-resizeme rs-parallaxlevel-0" 
					...
					style="z-index: 6; white-space: nowrap;">ETHEREUM 
				</div>
				...
				<div class="tp-caption BigBold-SubTitle   rs-parallaxlevel-0" 
					...
					style="z-index: 6; min-width: 410px; max-width: 410px; max-width: 60px; max-width: 60px; white-space: normal;"><b>EL ACTIVO DIGITAL</b>
				</div>
				...
				<div class="tp-caption BigBold-Button rev-btn  rs-parallaxlevel-0" 
					...
					style="z-index: 6; white-space: nowrap;border-color:rgba(255, 255, 255, 0.25);outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;">
						<a style="color: #FFFFFF" href="#ethereum">
							<b>LEER MÁS</b>
						</a>					
				</div>
			...
			<!-- SLIDE DASH -->
			<li data-index="rs-313" data-transition="slideoverhorizontal" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="1000"  data-thumb=""  data-rotate="0"  data-saveperformance="off"  data-title="Dash" data-description="">
				<!-- MAIN IMAGE -->
				<img src="assets/images/demo/monedas/banner/dash.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
				<!-- LAYERS -->
				<div class="tp-dottedoverlay twoxtwo"><!-- dotted overlay --></div>
				<!-- LAYER NR. 1 -->
				<div class="tp-caption tp-shape tp-shapewrapper   rs-parallaxlevel-0" 
				...
				<div class="tp-caption BigBold-Title   tp-resizeme rs-parallaxlevel-0" 
					...
					style="z-index: 6; white-space: nowrap;">DASH 
				</div>
				...
				<div class="tp-caption BigBold-SubTitle   rs-parallaxlevel-0" 
					...
					style="z-index: 6; min-width: 410px; max-width: 410px; max-width: 60px; max-width: 60px; white-space: normal;"><b>LA CRIPTODIVISA PEER-TO-PEER</b>
				</div>
				...
				<div class="tp-caption BigBold-Button rev-btn  rs-parallaxlevel-0" 
					...
					style="z-index: 6; white-space: nowrap;border-color:rgba(255, 255, 255, 0.25);outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;">
					<a style="color: #FFFFFF" href="#dash">
						<b>LEER MÁS</b>
					</a>					
				</div>
			...
			<!-- SLIDE LITECOIN -->
			<li data-index="rs-314" data-transition="slideoverhorizontal" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="1000"  data-thumb=""  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Litecoin" data-description="">
				<!-- MAIN IMAGE -->
				<img src="assets/images/demo/monedas/banner/litecoin-3344895.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
				<!-- LAYERS -->
				<div class="tp-dottedoverlay twoxtwo"><!-- dotted overlay --></div>
				<!-- LAYER NR. 1 -->
				<div class="tp-caption tp-shape tp-shapewrapper   rs-parallaxlevel-0" 
				...
				<div class="tp-caption BigBold-Title   tp-resizeme rs-parallaxlevel-0" 
					...
					style="z-index: 6; white-space: nowrap;">LITECOIN 
				</div>
				...
				<div class="tp-caption BigBold-SubTitle   rs-parallaxlevel-0" 
					...
					style="z-index: 6; min-width: 410px; max-width: 410px; max-width: 60px; max-width: 60px; white-space: normal;"><b>LA HERMANA DE BITCOIN</b>
				</div>
				...
				<div class="tp-caption BigBold-Button rev-btn  rs-parallaxlevel-0" 
					...
					style="z-index: 6; white-space: nowrap;border-color:rgba(255, 255, 255, 0.25);outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;">
					<a style="color: #FFFFFF" href="#litecoin">
						<b>LEER MÁS</b>
					</a>					
				</div>
			...
			<!-- SLIDE PETRO -->
			<li data-index="rs-315" data-transition="slideoverhorizontal" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="1000"  data-thumb=""  data-rotate="0"  data-saveperformance="off"  data-title="Petro" data-description="">
				<!-- MAIN IMAGE -->
				<img src="assets/images/demo/monedas/banner/petro-banner-1-1068x1068.png"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
				<!-- LAYERS -->
				<div class="tp-dottedoverlay twoxtwo"><!-- dotted overlay --></div>
				<!-- LAYER NR. 1 -->
				<div class="tp-caption tp-shape tp-shapewrapper   rs-parallaxlevel-0" 
				...
				<div class="tp-caption BigBold-Title   tp-resizeme rs-parallaxlevel-0" 
					...
					style="z-index: 6; white-space: nowrap;">PETRO 
				</div>
				...
				<div class="tp-caption BigBold-SubTitle   rs-parallaxlevel-0" 
					...
					style="z-index: 6; min-width: 410px; max-width: 410px; max-width: 60px; max-width: 60px; white-space: normal;"><b>RESPALDADA POR LAS RESERVAS NACIONALES DE ORO, PETRÓLEO, DIAMANTE Y GAS</b>
				</div>
				...
				<div class="tp-caption BigBold-Button rev-btn  rs-parallaxlevel-0" 
					...
					style="z-index: 6; white-space: nowrap;border-color:rgba(255, 255, 255, 0.25);outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;">
					<a style="color: #FFFFFF" href="#petro">
						<b>LEER MÁS</b>
					</a>
				</div>
...
-->
<section class="info-bar info-bar-dark" style="background-color: #041333">
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-4">
				...
				<p>Modalidades de negocio internacional.</p>
			</div>

			<div class="col-sm-4">
				<i class="fa fa-shield"></i>
				<h3>LA PLATAFORMA MÁS SEGURA</h3>
				<p>100% confiable.</p>
			</div>
			...
			<div class="col-sm-4">
				...
				<p>Contáctanos, estamos para servirte.</p>
			</div>
